...
BLOG_AUTHOR = "Seong-Kook Shin"  # (translatable)
BLOG_TITLE = "Seong-Kook Shin's Little World"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.cinsk.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.cinsk.org/"
BLOG_EMAIL = "cinsky at gmail.com"
BLOG_DESCRIPTION = "This is Seong-Kook Shin's personal web site."  # (translatable)
...
# BEGIN: orgmode plugin configuration
# Add the orgmode compiler to your COMPILERS dict.
COMPILERS["orgmode"] = ('.org',)

# Add org files to your POSTS, PAGES
POSTS = POSTS + (("posts/*.org", "posts", "post.tmpl"),)
PAGES = PAGES + (("stories/*.org", "", "story.tmpl"),)
# END: orgmode plugin configuration
